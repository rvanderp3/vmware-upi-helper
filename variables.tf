...
variable "winc_vm_template" {
  type        = string
  description = "This is the name of the winc VM template to clone."
}
...
//////////
// winc machine variables
//////////


variable "winc_vm_names" {
  type    = list(string)
  default = []
}

variable "winc_memory" {
  type    = string
  default = "16384"
}

variable "winc_num_cpus" {
  type    = string
  default = "4"
}
